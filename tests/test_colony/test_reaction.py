...
class TestReaction(unittest.TestCase):
    ...
    def testReactionConstructor(self):
        ...
        self.assertTrue(Reaction("PV", "Solar Power", products = {"E": 100.0}))
        self.assertTrue(Reaction("SPOIL", "Food Spoilage", inputs = {"FOOD": 1}))
        self.assertTrue(Reaction("CO2H2O", "Sabatier Reaction", inputs = {"CO2": 1, "H2O": 2}, products = {"CH4": 1, "O2": 2}))
    ...
    def testReactionAttribute(self):
        ...
        self.assertTrue(hasattr(r, "products"))
        self.assertTrue(isinstance(r.inputs, dict))
        self.assertTrue(isinstance(r.products, dict))