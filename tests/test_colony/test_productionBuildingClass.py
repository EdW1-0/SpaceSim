...
class TestProductionBuildingClass(unittest.TestCase):
    ...
    def testProductionBuildingConstructor(self):
        ...
        self.assertTrue(ProductionBuildingClass("MOCK", "Mock", reactions = {"ELECTROLYSIS": 2.0}))
        self.assertTrue(ProductionBuildingClass("MOCK", "Mock", constructionTime = 50, reactions = {"SABATIER": 2.0}))
        self.assertTrue(ProductionBuildingClass("MOCK", "Mock", constructionTime = 50, constructionCost = 30, reactions = {"SABATIER": 2.0}))
