    ...
    def goToColony(self, terminator, guiContext, model):
        ...
        if isinstance(guiContext, MenuContext):
            ...
            if self.runCount == 1:
                ...
                event = Event(
                    UI_BUTTON_PRESSED,
                    ui_element=guiContext.planet_summary.surface_button,
                )
                post(event)
            ...
            if self.runCount == 3:
                ...
                event = pygame.event.Event(
                    UI_BUTTON_PRESSED, ui_element=guiContext.vehicle_panel.colony_button
                )
                post(event)
                return True
        ...
        if isinstance(guiContext, MenuContext):
            ...
            if self.runCount == 1:
                ...
                post(
                    Event(
                        UI_BUTTON_PRESSED,
                        ui_element=guiContext.ship_summary.targetButton,
                    )
                )
            elif self.runCount == 4:
                ...
                post(
                    Event(
                        UI_BUTTON_PRESSED,
                        ui_element=guiContext.target_panel.surface_button,
                    )
                )
                ...
                post(
                    Event(
                        UI_BUTTON_PRESSED,
                        ui_element=guiContext.target_panel.confirm_button,
                    )
                )
                ...
                post(
                    Event(
                        UI_BUTTON_PRESSED,
                        ui_element=guiContext.timing_panel.start_button,
                    )
                )
                ...
                post(
                    Event(
                        UI_BUTTON_PRESSED,
                        ui_element=guiContext.timing_panel.stop_button,
                    )
                )
            ...
            if isinstance(guiContext, OrbitContext):
                ...
                if self.runCount == 54:
                    ...
                    post(
                        Event(
                            UI_BUTTON_PRESSED,
                            ui_element=guiContext.vehicle_panel.target_button,
                        )
                    )
                    ...
                    post(
                        Event(
                            UI_BUTTON_PRESSED,
                            ui_element=guiContext.ship_panel.launch_button,
                        )
                    )
                    ...
                    surfaceObj = model.planetSim.planetById(
                        "MERCURY"
                    ).surface.objectForContent(particle.payload)
    ...
    def colonyShipLaunchCallback(self, model, guiContext):
        if isinstance(guiContext, MenuContext):
            ...
            if self.runCount == 5:
                post(
                    Event(
                        UI_BUTTON_PRESSED, ui_element=guiContext.tab_panel.ships_button
                    )
                )
                ...
                post(
                    Event(
                        UI_BUTTON_PRESSED,
                        ui_element=guiContext.ship_detail_panel.target_button,
                    )
                )
                ...
                post(
                    Event(
                        UI_BUTTON_PRESSED,
                        ui_element=guiContext.ship_detail_panel.launch_button,
                    )
                )
...
class SystemTestColonySurfaceLaunchLand(SystemTestColonyShipLaunch):
    ...
    def colonyLaunchLandCallback(self, model, guiContext):
        ...
        if self.runCount == 9:
            ...
            post(
                Event(
                    UI_BUTTON_PRESSED, ui_element=guiContext.timing_panel.start_button
                )
            )
        elif self.runCount == 99:
            post(
                Event(UI_BUTTON_PRESSED, ui_element=guiContext.timing_panel.stop_button)
            )
