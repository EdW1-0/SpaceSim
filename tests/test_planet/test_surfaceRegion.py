...
class TestSurfaceRegion(unittest.TestCase):
    ...
    def testSurfacePathConstructor(self):
        ...
        self.assertEqual(SurfaceRegion(3, SurfacePoint(30.0, 30.0), []).homePoint, SurfacePoint(30.0, 30.0))
        
        self.assertEqual(SurfaceRegion(3, SurfacePoint(0.0, 0.0), self.triangle).borders[0].p1, SurfacePoint(-30, -30))
        self.assertEqual(SurfaceRegion(3, SurfacePoint(0.0, 0.0), self.triangle).borders[1].p1, SurfacePoint(-30, 30))
        self.assertEqual(SurfaceRegion(3, SurfacePoint(0.0, 0.0), self.triangle).borders[2].p1, SurfacePoint(30, 0))
